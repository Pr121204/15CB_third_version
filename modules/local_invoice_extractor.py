...
def check_local_completeness(mapped: Dict) -> bool:
    ...
    # currency_short is filled by map_local_to_gemini_format via Excel/manual
    # fallback, so if it is still invalid here both the extractor AND the Excel
...
def map_local_to_gemini_format(
    ...
    # Currency: use extractor's value; fall back to Excel/manual selection when missing
